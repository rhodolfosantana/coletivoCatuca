    		...
    		<div class="container-fluid">
    			...
    			<div class="collapse navbar-collapse" id="myNavbar">
    				<ul class="nav navbar-nav" style="width: 80%; text-align: center;">
    					...
    					<li><a href="view/view_about.php">Sobre</a></li>

    					<!--<li style="width: 80%">
    						<form class="pesquisa-ponto form-inline" style="display: inline-block; width: 90%;" action="view_search" method="POST">		
    					...
    					<ul class="nav navbar-nav navbar-right">
    						...
    						<li class="dropdown">
    							...
    							<ul class="dropdown-menu">
    								<li><a href="view/view_perfil.php">Perfil</a></li>
    			...
    			<div class="modal-dialog">
    				...
    				<div class="modal-content">
    					...
    					<div class="modal-body">
    						<form action="action/action_auth.php" method="POST">
