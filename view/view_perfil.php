	...
	<div id="corpo" class="container">
		...
		<div id="dados">
			<?php if(isset($_GET['att'])):?>
				...
				<form class="form-horizontal" action="action/action_auth.php" method="POST">
		...
		<h3>Seus Dados </h3>
			...
			<a href="view/view_perfil.php?att"><button class="btn-primary btn">Alterar Dados</button></a>
			<?php endif ?>
	</div>
	</div>
